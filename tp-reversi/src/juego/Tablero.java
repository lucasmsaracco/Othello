...
public class Tablero {
    ...
    private static final double DIMENSION_BOTON = 25;
    ...
    private void dibujarFondo() {
        ...
        grilla.setBackground(new Background(new BackgroundFill(Color.LIGHTBLUE, null, null)));
    ...
    private void dibujarMarcador() {
        ...
        Button botonVolverTurno = new Button("Deshacer");
//      botonVolverTurno.setMinSize(DIMENSION_BOTON, DIMENSION_BOTON);
//      botonVolverTurno.setMaxSize(DIMENSION_BOTON, DIMENSION_BOTON);
        botonVolverTurno.setOnAction(new volverTurnoAnterior(this,juego));
    ...
    private void dibujarFicha(int fila, int columna) {
        ...
        Rectangle dibujoCasillero = new Rectangle(TAMANIO_FICHA, TAMANIO_FICHA);
        dibujoCasillero.setFill(crearPintura(casillero));
        dibujoCasillero.setStroke(new Color(0, 0, 0, 1));
    ...
    private Border crearBorde() {
        ...
        BorderStroke trazo = new BorderStroke(Color.BLACK,
